...
class ProjectSDKBridge extends WTSDKBridge {
  void init() {
    ...
    /// MainAxisSize
    /// file: /Volumes/data/flutter_sdk/packages/flutter/lib/src/rendering/flex.dart
    pointerAttributeMap["min"] = (value) => value.min;
    pointerAttributeMap["max"] = (value) => value.max;
    /// Container
    /// file: /Volumes/data/flutter_sdk/packages/flutter/lib/src/widgets/container.dart
    pointerAttributeMap["alignment"] = (value) => value.alignment;
    pointerAttributeMap["padding"] = (value) => value.padding;
    pointerAttributeMap["foregroundDecoration"] = (value) => value.foregroundDecoration;
    pointerAttributeMap["constraints"] = (value) => value.constraints;
    pointerAttributeMap["margin"] = (value) => value.margin;
    /// Image
    /// file: /Volumes/data/flutter_sdk/packages/flutter/lib/src/widgets/image.dart
    pointerAttributeMap["image"] = (value) => value.image;
    pointerAttributeMap["frameBuilder"] = (value) => value.frameBuilder;
    pointerAttributeMap["loadingBuilder"] = (value) => value.loadingBuilder;
    pointerAttributeMap["errorBuilder"] = (value) => value.errorBuilder;
    pointerAttributeMap["width"] = (value) => value.width;
    pointerAttributeMap["filterQuality"] = (value) => value.filterQuality;
    pointerAttributeMap["colorBlendMode"] = (value) => value.colorBlendMode;
    pointerAttributeMap["fit"] = (value) => value.fit;
    pointerAttributeMap["repeat"] = (value) => value.repeat;
    pointerAttributeMap["centerSlice"] = (value) => value.centerSlice;
    pointerAttributeMap["gaplessPlayback"] = (value) => value.gaplessPlayback;
    pointerAttributeMap["excludeFromSemantics"] = (value) => value.excludeFromSemantics;
    pointerAttributeMap["isAntiAlias"] = (value) => value.isAntiAlias;
  }
}